        ...
        <div className="flex w-full justify-around">
            <div className="flex items-center">
                <div className="w-[416px] h-[288px]">
                    <h1 className="text-[24px] font-bold">Create new password</h1>
                    <p className="text-[16px] text-gray-400">Set a new password with a combination of letters and numbers for better security.</p>
