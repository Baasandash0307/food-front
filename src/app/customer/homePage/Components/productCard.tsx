...
const ProductCard = () => {
  ...
  return (
    <>
      {foodList.categories.slice(0, 1).map((category) =>
        category.foods.map((foodItem) => (
              ...
              <DialogTrigger className="ml-3.5 cursor-pointer">
                ...
                <div className="w-[460px]">
                  <div className="flex justify-between ml-2 items-center">
                    ...
                    <div className="text-[18px] font-bold">${foodItem.price}</div>
                  </div>
                </div>
                <div className="w-[470px]">
                  <div className="text-[14px] ml-2">{foodItem.description}</div>
                </div>
              </DialogTrigger>
              <DialogContent>
                <DialogTitle>
